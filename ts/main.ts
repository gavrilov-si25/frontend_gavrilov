interface CardData {
  ...
  export function createCardTemplate({ title, description, image }: CardData): string {
    return `
      <div class="card">
  ...
  export function displayCard(cardData: CardData): void {
  ...
  export function handleFeatureClicks(): void {
